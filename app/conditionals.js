...
//4. Write a function that will take in a number and return 'fever' if it indicates a 
// fever (over 98.6) and additionally if the person should go to the hospital 
